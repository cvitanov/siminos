...
% $Author: predrag $ $Date: 2017-04-24 17:25:47 -0400 (Mon, 24 Apr 2017) $
...
\begin{frame}{problem}
unable to compute invariant solutions for large spatial domains
    \footfullcite{WFSBC15}%$^,$%
    %\footfullcite{WK09}
...
{\Large
solutions on large domains are too unstable
                  }
\end{frame}
...
goal
    \footfullcite{GutOsi15}%$^,$%
    %\footfullcite{WK09}
: determine symbolic dynamics, construct Book of Life
             }
\begin{center}
