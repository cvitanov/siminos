% siminos/presentations/kittens/kittens.tex        pdflatex kittens; biber kittens
% $Author: predrag $ $Date: 2020-10-09 17:56:44 -0400 (Fri, 09 Oct 2020) $

% when you get      LaTeX Error: Command \block already defined.
%                   l.512 \newcommand{\block}[1]{\ensuremath{#1}}
% press [Enter] once

% FROZEN, split into                                          2020-09-25
...
\ee{1stepDiffEq}
field $\ssp_\zeit$, source $\Ssym{\zeit}$ \\
...
\begin{frame}{exponentially many distinct walks through Bernoulliland}
\begin{center}
...
weakly coupled map lattice models\footfullcite{BunSin88}
\bigskip
...
\hfill\includegraphics[width=0.7\textwidth]{Holmin15-Fig1}
    \end{block}
\bigskip
