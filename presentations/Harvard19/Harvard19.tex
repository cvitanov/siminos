% siminos/presentations/spatiotemp/Harvard19.tex
% $Author: predrag $ $Date: 2019-03-31 19:36:23 -0400 (Sun, 31 Mar 2019) $
...
\includegraphics[width=\textwidth,height=.50\textheight]{MNG_ppo1_noise_init}
\end{minipage}
\begin{minipage}[height=.40\textheight]{.35\textwidth}
\centering %\small{\texttt{(right)}}
\includegraphics[width=\textwidth,height=.50\textheight]{MNG_ppo1_noise_conv}
\end{minipage}
