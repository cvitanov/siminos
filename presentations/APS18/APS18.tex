% siminos/presentations/APS18/APS18.tex        pdflatex APS18
% $Author: predrag $ $Date: 2018-03-05 16:19:51 -0500 (Mon, 05 Mar 2018) $
...
\newcommand{\D}{\mathcal{D}}                    % Boris
\newcommand{\gd}{\mathsf{g}}                    % Boris
...
\begin{block}{Navier-Stokes $(1+3)$\dmn\ PDEs} % (1822)}
\[
\bv_t + (\bv \cdot \nabla) \bv
	\,=\,
\mathbf{f}
...
\begin{frame}{evolution of \KS\ in a minimal cell} %small $L=22$ cell}
\begin{center}
...
\begin{frame}{how to find solutions ? \hspace{10ex}  a 1\dmn\ example}
\begin{center}
\begin{minipage}[c]{0.55\textwidth}
...
\begin{frame}{thinks of what follows as a crude latticization of turbulence}
tile

\bigskip
\begin{minipage}{0.33\textwidth}
\begin{center}
\includegraphics[width=1.0\textwidth]{KSL100N256}
...
\begin{center}
\includegraphics[width=0.3\textwidth,height=0.34\textheight]{ksrpo2T100NoLabel}
...
\begin{frame}{the simplest such system : a cat map evolving in time}
...
\begin{frame}{this is a discretized Euclidean space-time field theory}
...
\begin{frame}{{\catlatt} is linear - we can solve it}
...
\begin{frame}{what role do the spatiotemporal neighbors play ?}
...
\begin{frame}{take home 1 : symbolic dynamics for turbulence}
