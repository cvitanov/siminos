...
\addbibresource{../bibtex/siminos.bib}
    \fi
\input{defsReversal}      %% all article-specific edits: \renewcommand, etc
...
\input{../spatiotemp/chapter/LC21abstract}
% \input{abstract} eventually, return to here
    \end{abstract}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{../spatiotemp/chapter/LC21intro}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21FT}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21Bernoulli}
\input{../spatiotemp/chapter/LC21cat}
\input{../spatiotemp/chapter/LC21nonlinFT}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21recip1d}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21JacobianOrb}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21Hill}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21latt1d}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21zeta1d}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21Lind1d}
    \ifboyscout\clearpage\fi
\input{../spatiotemp/chapter/LC21summary} %\input{summary}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    } %end \PCedit{
    ...
    \input{../spatiotemp/chapter/LC21blog}
    \fi %end of the internal draft switch
