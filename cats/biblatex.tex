% siminos/inputs/cats/biblatex.tex
% $Author: predrag $ $Date: 2019-12-05 14:24:36 -0500 (Thu, 05 Dec 2019) $

% Predrag 2019-12-05 backend=biber,  % was backend=bibtex,
...
\usepackage[
    backend=biber,  % was     backend=bibtex,
    sorting=nyt,
