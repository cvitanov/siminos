...
('$'+str(0)+'$', ' $'+str(tfrpo/2)[0:4]+'$', '$'+str(tfrpo)[0:4]+'$'), fontsize=24)

#savefig('ksconfrpo.pdf', bbox_inches='tight', dpi=10)
#fig.text(-0.22, 0.0, '$(d)$', fontsize=32)
savefig('ksconfrpo.png', bbox_inches='tight', dpi=264)
...
y = trpored[range(0,np.size(trpored),10)]

im = plt.pcolormesh(x, y, usolrpored[range(0,np.size(trpored),10),:], shading='gouraud')
...
#savefig('ksconfrpored.pdf', bbox_inches='tight', dpi=10)
#fig.text(-0.22, 0.0, '$(e)$', fontsize=32)
savefig('ksconfrpored.png', bbox_inches='tight', dpi=264)
...
('$'+str(0)+'$', '$'+str(np.floor(tftw/2))[0:3]+'$', '$'+str(tftw)+'$'), fontsize=24)

#savefig('ksconftw.pdf', bbox_inches='tight', dpi=10)
#fig.text(-0.22, 0.0, '$(a)$', fontsize=32)
savefig('ksconftw.png', bbox_inches='tight', dpi=264)
...
#savefig('ksconftwred.pdf', bbox_inches='tight', dpi=10)
#fig.text(-0.22, 0.0, '$(b)$', fontsize=32)
savefig('ksconftwred.png', bbox_inches='tight', dpi=264)
...
#im = plt.pcolormesh(x, y, usolrand[range(0,np.size(trand),40),:],
#                   shading='gouraud')

#plt.axis([x.min(), x.max(), y.min(), y.max()])

#plt.xlabel('$x$', fontsize=32)
#plt.ylabel(r'$\tau$', fontsize=32)
	
#plt.xticks([x[0],x[np.floor(np.size(x)/2)],x[-1]], ('$- L/2$', '$0$', '$L/2$'), fontsize=24)
##plt.yticks([y[0],y[np.floor(np.size(y)/2)],y[-1]],
##('$'+str(y[0])[0:5]+'$', '$'+str(y[np.floor(np.size(y)/2)])[0:3]+'$', '$'+str(y[-1])[0:3]+'$'))
#plt.yticks([0,tfrand/2,tfrand],
#('$'+str(0)+'$', '$'+str(np.floor(tfrand/2))+'$', '$'+str(tfrand)+'$'), fontsize=24)
...
##savefig('ksconfrandred.pdf', bbox_inches='tight', dpi=10)
#savefig('ksconfrandred.png', bbox_inches='tight', dpi=100)
