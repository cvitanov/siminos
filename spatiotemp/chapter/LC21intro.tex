...
\refsect{s:1D1dLatt} we reformulate the forward-in-time Bernoulli map as
...
`\catlatt'\rf{GutOsi15,GHJSC16,CL18}, is a discretization of the
...
action $S[\Xx]$ and the {\jacobianOrb}, as in \refeq{LC21:1dTempFT},
