...
\beq
V[\ssp_{\zeit}] =
        \frac{a}{3}\ssp_{\zeit}^3 + \ssp_{\zeit}^2
\,,
\ee{LC21BWcubic}
giving rise to kicking pulse \refeq{LC21PerViv2.1a}.
    \PC{2021-12-10} {
Redefined the cubic Biham-Wenzel potential to agree with \refeq{LC21:1dTempFT}.
Originally
\beq
V[\ssp_{\zeit}] - m_\zeit\ssp_\zeit =
        %\ssp_{\zeit+1}\ssp_{\zeit} + \,\ssp_{\zeit}\ssp_{\zeit-1}
        \frac{a}{3}\ssp_{\zeit}^3 - \ssp_{\zeit}
    \,,\qquad
        m_\zeit = -1
\,,
\ee{LC21BWcubicOLD}
