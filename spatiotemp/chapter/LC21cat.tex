...
map\rf{Lichtenberg92,Chirikov79}, to the cat maps that we turn to now.
The equations are of the Hamiltonian form: eq.~\refeq{LC21PerViv2.1b} is
$\dot{\coord}=p/m$ in terms of discrete time derivative
\refeq{lattTimeDer}, \ie, the configuration trajectory starting at
$\coord_{\zeit}$ reaches
...
\refeq{eq:StateSpCatMap} takes a particularly elegant form, that we shall
...
\refref{CL18}. {\catLatt} differs from all of the above model because the
