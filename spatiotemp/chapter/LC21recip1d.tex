...
\Cn{n}, and one needs to distinguish \Cn{n} {\orbit}s (''prime cycles'' in
...
\beq
\overline{\lattice}_{\mathbf{b}} = \{n \mathbf{b}\,|\, n \in \mathbb{Z}\}
\,,
\ee{LC21:Rcpr1dLatt}
...
= \tilde{\ssp}_{0} \tilde{e}_0 + \tilde{\ssp}_{1} \tilde{e}_1
