...
prime {\orbit}s holds.
The \statesp\ \pS\ of a $\Dn{\infty}$ invariant dynamical is union of 2 subspaces:
\beq
\pS = \pS_{a} \cup \pS_{s}
\,,
\ee{pSunion2}
...
any kind of reflection \refeqs{reflSymOdd}{reflSymEvens1}. Kim \etal\rf{KiLePa03}
...
1/\zeta_{\mbox{\footnotesize KLP}}(t)|_{p}=
          \left\{
            \begin{array}{ll}
\, 1 - t^{\cl{p}} \,, \qquad \mbox{ if } p \in \pS_{a} \,, \\ %[1ex]
...
\prod_{p_1\in\pS_{a}} (1 - t^{\cl{p_1}})
\prod_{p_2\in\pS_{s}} \sqrt{1 - t^{2\cl{p_2}}}
\exp\left(-\frac{t^{\cl{p_2}}}{1-t^{\cl{p_2}}}\right)\,.
\ee{KLPzetaProd}
