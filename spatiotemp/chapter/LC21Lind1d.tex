...
\,.
\ee{LC21Ryu17eq:1.3A}
The index $|\Group/{H}|$ is best explained by working out a few examples.
...
reflections \refeq{LC21D_infty}. Their finite-index subgroups $H$ are,
...
\refeq{LC21Ryu17eq:1.3} can replaced by the sum over periods $\cl{}$.
$N_\cl{}$ is the number of {\lattstate}s of period $\cl{}$, and the index
$|\Group/{H}|$ is the multiplicity of orbit $\pS_\Xx$
\refeq{GroupOrbMult}. For \Cn{\infty} subgroups --see
\reffig{fig:1dLatStatC_5}\,(1)--$\shift_4$)-- the multiplicity is
$|\Cn{\infty}/H_\cl{}|=\cl{}$, and the Lind zeta function
\refeq{LC21Ryu17eq:1.3} reduces to the familiar Artin-Mazur zeta
func\-tion \refeq{topoZeta}.

Consider next the case that the symmetry group of temporal lattice a
given dynamical system is the {infinite dihedral group}
$\Dn{\infty}$  of all translations and reflections\rf{KiLePa03}, \ie,
that the defining law of dynamics is time and time-reversal invariant.
