...
The {temporal Bernoulli} condition \refeq{tempBern},
the {\templatt} discretized Euler–\-Lagrange equation \refeq{catTempLatt}
...
\noindent
{Temporal Bernoulli} \refeq{bernFixPoint}
\beq
...
\noindent
Nonlinear field theory \refeq{LC21:2-step}
\beq
\jMorb[\Xx] =
\left(\begin{array}{ccccccc}
%\begin{pmatrix}
...
is not Toeplitz: it is evaluated on a {\lattstate} \Xx, with the
