...
Hessian of the action functional).

Hill's relates the monodromy matrix of the periodic trajectory, to
...
Mackay and Meiss\rf{MacMei83} derived a formula
\refeq{MacMei83(17)} for the multipliers of a \po\ for general discrete-time
one-degree-of-freedom systems.

The equation
appeared in 1983 for discrete Lagrangian systems in \refref{MacMei83},
