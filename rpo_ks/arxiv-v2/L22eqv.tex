% L22eqv.tex
% $Author: siminos $ $Date: 2009-04-10 23:40:55 -0400 (Fri, 10 Apr 2009) $
...
in \refrefs{Christiansen97,lanCvit07} that within particular
...
\begin{figure}[t]
\begin{center}
  (\textit{a})\includegraphics[width=0.35\textwidth, clip=true]{figs_bmp/1wKS22equil.eps}
~~~~(\textit{b})\includegraphics[width=0.35\textwidth, clip=true]{figs_bmp/2wKS22equil.eps}
\\
  (\textit{c})\includegraphics[width=0.35\textwidth, clip=true]{figs_bmp/3wKS22equil.eps}
~~~~(\textit{d})\includegraphics[width=0.35\textwidth, clip=true]{figs_bmp/equilSpatial.eps}
\end{center}
\caption{
...
Gibson\rf{GHCW07,GibsonMovies}, better suited to visualization
