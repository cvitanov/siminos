% siminos/gudorf/thesis/chapter/discsymm.tex
...
discrete symmetry subgroup is $\Zn{2} \times \Cn{2}$.
    ...
    % PC commented out, was in Siminos thesis               2020-05-22
%\section{Symmetries of \KSe}
%\label{sect:KSsymm}
%\input{chapters/KSsymm}

\section{Fourier transform normalization factors}
\label{sect:FTnormal}
\input{chapters/FTnormal}
