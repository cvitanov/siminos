% siminos/xiong/thesis/defsThesis.tex
% $Author: predrag $ $Date: 2021-02-01 22:04:33 -0500 (Mon, 01 Feb 2021) $

%%%%%%%%%%%% Xiong Ding thesis definitions %%%%%%%%%%%%%%%


\newcommand{\advise}[1]{$\footnotemark\footnotetext{Roman 2017-03-05: {\color{red}#1} }$ } %date, comment
\renewcommand{\Xiong}[1]{ $\footnotemark\footnotetext{Xiong 2017-03-25: {\color{blue} #1} }$ } %date, comment

% Xiong's deviations form ChaosBook conventions
%\renewcommand{\statesp}{phase space}   % Xiong's preference
%\renewcommand{\Statesp}{Phase space}   % Xiong's preference
%\renewcommand{\stateDsp}{phase-space}   % Xiong's preference
%\renewcommand{\StateDsp}{Phase-space}   % Xiong's preference
%\renewcommand{\pS}{H}   % Xiong's preference
%\renewcommand{\ssp}{u}   % Xiong's preference
\newcommand\semiflow[1]{{f^{#1}}}
%\newcommand\semiflow[1]{{S(#1)}}  % Xiong's preference
\newcommand{\spt}{spatiotemporal}
\newcommand{\Spt}{Spatiotemporal}
\newcommand{\vlo}{A}            % linear part of the velocity
\newcommand{\vno}[1]{F{#1}}     % nonlinear part of the velocity
\newcommand{\IM}{\mathcal{I}}
\newcommand{\lowmode}{low frequency mode}
\newcommand{\Lowmode}{Low frequency mode}
\newcommand{\highmode}{high frequency mode}
\newcommand{\Highmode}{High frequency mode}
\newcommand{\lowFmode}{low frequency Fourier mode}
\newcommand{\LowFmode}{Low frequency Fourier mode}
\newcommand{\highFmode}{high frequency Fourier mode}
\newcommand{\HighFmode}{High frequency Fourier mode}
\newcommand{\Gepp}{Gaussian elimination with partial pivoting}
...
\renewcommand{\twomode}{two-mode} %Fourier transform of a scalar field
\renewcommand{\twoMode}{Two-mode} %Fourier transform of a scalar field
...
\renewcommand{\conf}{\ensuremath{x}} %Configuration space coordinate
