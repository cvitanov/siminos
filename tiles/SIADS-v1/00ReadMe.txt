siminos/tiles/SIADS-v1/00ReadMe.txt
$Author: predrag $ $Date: 2019-03-16 17:14:50 -0400 (Sat, 16 Mar 2019) $
===========================================================
                    started writing: Predrag 10 Mar 2019
...
copy all source files and figs from tiles/current/ to  SIADS-v1/
...
tiles/current/figs/ to  SIAD-v1/figs/
    [ ] mark here when done

submit to SIADS
    [ ] created rpo.tex for SIADS submission
    arxiv-v1/*.tex *.bst *.cls figs/* rpo.bbl [NO rpo.bib! please]
    [ ] tiles/SIADS-v1/reviews/response2.1.txt
    [ ] coverLettResubm.tex
...
!!! then DO NOT TOUCH SIAD/* again, edit only tiles/current/
===============================================================
